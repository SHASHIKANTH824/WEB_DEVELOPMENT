const questionBank = [
  ...
  method-1 : less optimised way, it's time cmplexcity is "nlogo(n)" .
...
method-2 : more optimised way than method-1 , it's time complexity is "order of n '(o(n)' )"
...
// method-3 : more optimized way than method 1 & 2 , it's time complexity is " number of element to select. it's best case is "order of 1 '(o(1))'" "
function RandomQuestion(){
  ...
  for(let i=0;i<5;i++)
  {
    ...
    [questionBank[index],questionBank[length-1]] = [questionBank[length-1],questionBank[index]];  // here we are doing swaping.
    length--;
  }
